...
function data_search(){
    ...
    for(var line=1; line<=5; line++){
        ...
        if( num_arr.length==6){
            ...
            var NumGrade = document.getElementsByClassName("resultNumberGrade");
            NumGrade[line-1].innerHTML=rank;
        }
